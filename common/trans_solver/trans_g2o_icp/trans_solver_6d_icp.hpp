 ...
 * Description: 6DOD icpration solver
 */

#ifndef _TRANS_SOLVER_6D_ICP_HPP_
#define _TRANS_SOLVER_6D_ICP_HPP_
...
template<class T>
class TransSolver6DICP : public TransSolverBase<T, Eigen::Isometry3d>
{
	public:
	TransSolver6DICP() ;
...
#endif // _TRANS_SOLVER_6D_ICP_HPP_
