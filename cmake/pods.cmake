...
# pods_install_python_script(<script_name> <python_module_or_file> [<source_first>])
#
...
#
# If the third argument, <source_first>, is nonempty, then the path to the
# location of the package source is placed at the front of PYTHONPATH.
# E.g., this is useful for development because it is not necessary to run `make`
# to witness changes to the Python code.
#
# example:
...
function(pods_install_python_script script_name python_module_or_file)
    ...
    # If third argument is nonempty, then add pointer to the sources.
    if(${ARGC} GREATER 2)
	set(python_install_dir
	    ${CMAKE_CURRENT_SOURCE_DIR}:${python_install_dir})
    endif()
